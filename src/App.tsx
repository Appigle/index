...
function App() {
  ...
  return (
    <>
      <div className="flex flex-col items-center pt-[160px] h-screen w-screen bg-index-bg">
        <h1 className="text-5xl font-bold text-purple-300 uppercase animate-pulse cursor-progress">
          Home Of Ray
        </h1>
